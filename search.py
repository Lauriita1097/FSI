...
#Funcion añadida
def cost_graph_search(problem):
    return graph_search(problem, CostQueue())

#Función añadida para la heurística
def branch_and_bound_with_underestimation_graph_search(problem):
    return graph_search(problem,SortedListByCostAndHeuristic(problem))
